...
description: In this post we use the Chi-Square Hypothesis Test to analyse the results of an A B Test to understand if there is a significant difference in signup rate between their cheap mailer and their expensive mailer
image: "/posts/abtest.jpeg"
...
```
<br>
As we can see from the outputs of these print statements, we do indeed retain the null hypothesis.  We can not find enough evidence that the signup rates for Mailer 1 and Mailer 2 were different - and thus conclude that there was no significant difference.
